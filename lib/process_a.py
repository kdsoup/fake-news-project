...
def preprocess(dataframe) -> None:
    ...
    dataframe['content_clean'] = dataframe['content'].apply(clean_text)

    # Apply remove_stopwords to 'content_clean' column and create 'content_stopword' column
    dataframe['content_stopword'] = dataframe['content_clean'].apply(remove_stopwords)

    # stemming
    dataframe['content_stem'] = dataframe['content_stopword'].apply(remove_word_variations)
